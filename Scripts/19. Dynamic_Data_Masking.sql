...
-- Use Masking Policy while Making table..
...
CREATE OR REPLACE TABLE CREDIT_CARD_CUSTOMER
    ...
    -- Do for PAN
     ...
     GRANT USAGE ON DATABASE TESTDB TO ROLE BI_ROLE; 
     GRANT ALL ON SCHEMA TESTDB.TESTSCHEMA TO ROLE BI_ROLE;
     GRANT SELECT , INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA TESTDB.TESTSCHEMA TO ROLE BI_ROLE;
